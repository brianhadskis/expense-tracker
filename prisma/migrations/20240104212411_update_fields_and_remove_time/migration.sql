/*
  ...
  - You are about to drop the column `modified` on the `transaction` table. All the data in the column will be lost.
  ...
  - Added the required column `updatedAt` to the `GoalAction` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `billpayment` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL;
...
-- AlterTable
ALTER TABLE `goal` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL;

-- AlterTable
ALTER TABLE `goalaction` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL;
